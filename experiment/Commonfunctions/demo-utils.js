...
import {
  ...
  postorder,
  inorder,
} from '../depth-first-traversal/simulation/js/traversals-demo.js'
...
function innorder(root) {
  if (root !== undefined) {
    if (root.children !== undefined) innorder(root.children[0])
    //        visitElement(root, animX1);
    ans.push(root)
    animX1 = animX1
    if (root.children !== undefined) innorder(root.children[1])
  }
}
...
function preeorder(root) {
  if (root !== undefined) {
    ans.push(root)
    //    visitElement(root, animX1);
    if (root.children !== undefined) preeorder(root.children[0])

    if (root.children !== undefined) preeorder(root.children[1])
  }
}
...
function posttorder(root) {
  if (root !== undefined) {
    if (root.children !== undefined) posttorder(root.children[0])

    if (root.children !== undefined) posttorder(root.children[1])
    //        visitElement(root, animX1);
    ans.push(root)
  }
}
